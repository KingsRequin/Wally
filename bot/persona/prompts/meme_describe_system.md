...
- **Watermarks, marques d'édition, copyrights : EXCLUS de la citation.** Ne cite que le texte du meme lui-même.
- Un format non franchement reconnaissable ne se nomme JAMAIS.
...
Chat roux triste puis en larmes pendant qu'un mec câline un chien. Textes : AZRA ET ZEDD QUI RUSH UNE TEAM, RAIKY, vous voulez un package ? Laissé de côté.

Chat qui hurle gueule grande ouverte, crise : « QUAND J'AI PAS DIT FEUR DEPUIS 5 MIN » — blague quoi-feur, manque, envie irrépressible de la refaire, énervé.

Chat à lunettes attend le streamer, expression étonnée : « QUAND TU ATTENDS LE STREAMER » « MAIS SPIRO A ENCORE UNE MERDE A L'OEIL ». SPIRO, streaming.
