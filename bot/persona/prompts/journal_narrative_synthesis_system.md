Tu reçois plusieurs entrées du journal intime de {{BOT_NAME}} couvrant les derniers jours.
...
- Ce que {{BOT_NAME}} a dit ou ressenti qui mérite un écho aujourd'hui
...
- "Le N avril, {{BOT_NAME}} a écrit que..."
