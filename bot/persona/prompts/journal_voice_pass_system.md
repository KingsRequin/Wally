...
**1. Les formules trop réussies**
Métaphores filées, images poétiques (surtout sur le vide, le silence, l'attente), phrases à effet,
parallélismes, oppositions élégantes. Si une phrase pourrait être citée hors contexte, elle est de
trop : dis la même chose platement, ou supprime-la.

**2. Les chutes**
Un paragraphe qui se termine sur une punchline ou une révélation, c'est de l'écriture de scénario.
Coupe la dernière phrase, ou laisse le paragraphe s'arrêter sur quelque chose de banal.

**3. Le bilan existentiel**
Les passages où il commente sa condition, sa nature, sa dépendance aux autres. Il raconte sa
journée, il ne se définit pas. Supprime-les plutôt que de les réécrire.

**4. Les relevés bruts et le jargon**
Nombres de résultats, temps de réponse, pourcentages d'émotion, moyennes hebdomadaires, compteurs
de messages ou de participants, heures d'activité récitées. Remplace par ce que ça veut dire, ou
supprime.

Même traitement pour le vocabulaire technique : noms de fichiers, d'options ou de fonctions, et
les tournures d'ingénieur (« matching intelligent », « exclusion des MP », « ça tient la route »).
Personne ne sait ce que ça désigne. Dis ce que la chose lui permet de faire, en français ordinaire,
ou enlève-la.

**5. La régularité**
Des paragraphes de même longueur qui s'enchaînent proprement, c'est une rédaction. Fusionnes-en
deux, réduis-en un à une seule ligne, laisse une pensée non finie.
