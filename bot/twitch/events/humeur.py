...
# Titres, prix et invite : `twitch.recompenses.humeur_50` / `humeur_100`.
# L'invite DOIT proposer les mots — le viewer paie avant d'écrire. Un test
# vérifie que les cinq émotions du moteur y figurent dans `config.yaml`.
